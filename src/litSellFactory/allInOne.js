...
const stubPkpInfo = {
  publicKey: '0x04e0fe6a5e9447112a272b3bfea3cbcb48a730c731d9edd434417d30f5b25966cb8543cece8ba67fd6bbbb9ba952e28db541de9a898cca0257e5479033c3b7b021'
}
...
async function executeSwap({tokenIn, tokenOut, pkp, authSig, amountToSell, provider}) {
  ...
  if (litActionRes['signatures'] && Object.keys(litActionRes['signatures']).length === 2) {
    console.log('Signing approveTx');
    const signedApproveTx = joinAndSignTx({litActionRes, tx: approveTx, key: 'approveTx'});
    console.log('Signing exactInputSingleTx');
    const signedExactInputSingleTx = joinAndSignTx({litActionRes, tx: exactInputSingleTx, key: 'exactInputSingleTx'});
    ...
    try {
      ...
      console.log('Successful swap - signedExactInputSingleTxRes:', signedExactInputSingleTxRes);
    } catch (err) {
